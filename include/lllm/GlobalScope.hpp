...
namespace lllm {
	class GlobalScope : public util::Scope<ast::VariablePtr>, public util::Scope<value::ValuePtr> {
		public:
			void add( const util::SourceLocation& loc, const util::InternedString& name, value::ValuePtr val );
